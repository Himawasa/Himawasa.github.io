...
export const CARDSYNC_FAQS = [
  ...
  },
  {
    ...
    a: 'カードの裏面に、署名入りの QR コードを印刷できます。スマートフォンの標準のカメラで読み取ると、本当に発行されたカードか、有効期限内かがその場で分かります。専用アプリは不要です。QR を書き換えると「確かめられませんでした」と表示され、名簿から削除した方のカードは「すでに使われていません」に変わります。QR に氏名は含めていないため、読み取られても個人情報は漏れません。',
  },
  {
