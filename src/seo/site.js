...
export const PAGES = {
  ...
  try: {
    ...
    h1: '無料で体験できるミニアプリ',
    description:
      'MochiSync・PDFuse Sync・LegoSync・SukkiriSync。写真やPDFで、自動化の感触を先に試せます。法人向けのご相談とは別のサービスです。登録やログインはいりません。',
...
export const FAQS = [
  ...
  {
    q: 'うちの規模でも、お願いできますか？',
    a: '士業事務所、介護・医療の現場、中小企業が中心です。大企業向けのパッケージ売りではありません。「毎月の泥臭い作業」が残っている現場なら、お役に立てることがあります。',
  },
  {
    q: 'AIで作ったシステムでも、見てもらえますか？',
    a: '見ます。思い通りに動いているものも、止まっているものもあります。中身がわからないまま残っているなら、まず一緒に整理します。どなたが作ったものでもかまいません。',
  },
  {
    q: 'AIの使い方がわからなくても、相談できますか？',
    a: 'できます。道具の名前から始めなくて大丈夫です。「毎月これが面倒」から話してください。AIは隙間を埋める助手です。使い方も含めて、そばでお手伝いします。',
  },
  {
  ...
  {
    q: '相談する前に、試せますか？',
    a: 'できます。無料体験のページに、持ち物チェックやPDF変換など、先に触れるミニアプリがあります。法人向けの仕組みとは別です。登録やログインはいりません。',
  },
]
...
export const AI_ERA = {
  ...
  lead: 'AIは、隙間を埋める助手です。使い方がわからないところからでも、一緒に進めます。',
  points: [
    {
      title: 'AIは、隙間を埋める助手',
    ...
    },
    {
      ...
      text: '専門用語やツールの名前は知らなくて大丈夫です。「日々の業務でどこが一番面倒か」をお聞かせいただければ、どうすれば楽になるかを一緒に考えます。',
    },
    {
      title: '作ったあとも、仕組みが分かる人がそばにいます',
      text: '作った後も、現場で動かしながら調整を続けます。「納品して終わり」にはせず、使い始めてからの手直しも引き受けます。',
    },
  ],
}
    ...
    graph.push({
      ...
      offers: [
        ...
        },
        {
          ...
          price: '5000',
          priceCurrency: 'JPY',
          description: '月5,000円から。止まったら、動く状態に戻します。',
          url: `${SITE.url}/rk/`,
        },
      ],
    })
