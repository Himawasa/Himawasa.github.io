  ...
  care: {
    ...
    cite: {
      ...
      facts: [
        ...
        'シフトはKING OF TIMEなどの勤怠データから、施設指定の様式へ載せます。病院は、人が画面やCSVで出している範囲だけを転記します。金額を確定するのは、これまでどおり担当の方です。',
    ...
    features: [
      {
        num: '01　入所のとき',
        title: '持ち物チェック',
        text: '持ち物の写真から、一覧表を作ります。',
        result: '紙を見ながら一つずつ確かめる手間を減らします。',
    ...
    extra: [
      { title: '日計・収入の転記', text: '電子カルテや医事ソフトから出した数字を、指定の日計Excelへ。最後の確認は、担当の方が行います。' },
      { title: '夜間のCSV抜き出し', text: 'カルテが空く時間に統計を取り、翌朝のたたき台を置いておく。' },
      { title: '複数拠点のExcel統合', text: '病院ごと・科ごとにばらばらに作られたExcelを、本部の1枚にまとめます。' },
    ],
    links: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '頼めます。人が今、画面やCSVで出している範囲だけです。金額を確定するのは、これまでどおり医事課の方です。詳しくは医療機関向けの事例もご覧ください。',
      },
      {
        q: '現場の職員でも使えますか？',
  ...
  factory: {
    ...
    cite: {
      ...
      facts: [
        ...
        '品番・ロット番号・数量は入力どおりに残します。原因や対策を決めるのは、これまでどおり現場の方です。',
    ...
    features: [
      ...
      },
      {
        ...
        result: '写す作業だけを減らします。確認は現場の方が行います。',
