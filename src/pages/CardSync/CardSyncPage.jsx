...
const REASONS = [
  ...
  {
    kicker: '03',
    title: '実寸・300DPI の高画質。画面で仕上がりを確かめて発行',
    body: '実寸（85.6 × 54 mm）・印刷品質（300DPI）で、表裏両面の仕上がりを画面上に忠実に再現します。1人ずつ仕上がりを確認したうえで、社内のプリンタで印刷、または PDF に保存してまとめて発行。万が一の紛失や破損による再発行も、理由とともに履歴がしっかり残ります。',
