...
const hlItems = [
  { icon: '👔', title: 'IT業界25年・カスタマーサクセス', text: 'カスタマーサクセスの現場から、技術部隊の統括まで。「話を聞いてから作る」「止まったら、動く状態に戻す」を基本にしています。' },
      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <Reveal direction="right" className="about-right">
            ...
            <p>IT業界25年。<strong>中小企業の技術部隊を束ねてきたマネジメント経験</strong>と、現場で汗をかいた実務経験を掛け合わせ、今は45件以上の業務システムを設計・開発・本番運用しています。</p>
