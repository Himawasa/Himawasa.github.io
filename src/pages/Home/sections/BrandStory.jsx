...
/** ③ ブランドストーリー */
const brandCards = [
  { icon: '🌻', title: 'Sync = 「つなぐ」', text: '仕事と生活を、現場の人と新しい道具をつなぎます。手作業が減った分だけ、家族と過ごす時間が増えるように。' },
  { icon: '📐', title: 'シンプルさへのこだわり', text: '難しいITは、使われません。初日から、現場の人が触れる形にします。' },
  { icon: '⚡', title: '安く、早く動かす', text: '大きなシステムは入れません。今のGoogleとExcelのまま、安く早く動かします。' },
  { icon: '🤝', title: '作って終わりにしない', text: '不具合で止まったら、動く状態に戻します。使い始めてからの細かい直しも引き受けます。' },
]
