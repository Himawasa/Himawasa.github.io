...
const values = [
  ...
  { icon: '✨', title: '難しい言葉を使わない', heading: '難しい言葉を使わない', text: '「API」「インスタンス」のような言葉は使いません。現場で使っている言葉で話し、一緒に考えます。' },
  { icon: '🌱', title: '小さく作って、一緒に育てる', heading: <>小さく作って、一緒に<span className="nowrap">育てる</span></>, text: '最初から完璧なものは作れません。まず動くものを早く出して、使いながら直します。' },
  { icon: '🤝', title: '作ったあとも、ずっと', heading: '作ったあとも、ずっと', text: '使い始めてからの手直しや改善も、続けて引き受けます。困ったときに気軽に連絡できる相手でいたいと思っています。' },
]
